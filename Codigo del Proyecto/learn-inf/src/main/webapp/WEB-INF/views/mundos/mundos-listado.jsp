...
<main>
    ...
    <div class="container">
        <div class="row m-3 text-center">
            ...
            <c:forEach var="mundo" items="${mundos}">
                <div class="col-xl-4 col-md-6 col-sm-12">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h3 class="my-0 fw-normal">Mundo ${mundo.id}</h3>
                            <h5>Dificultad: ${mundo.dificultad}</h5>
                        </div>
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title">${mundo.tematica}</h1>
