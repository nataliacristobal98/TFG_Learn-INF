                        ...
                        <form method="post" id="formulario" onsubmit="recogerValores(event)">
                                                ...
                                                <c:forEach var="respuesta" items="${respuestas}">
                                                    <c:choose>
                                                        <c:when test="${respuesta.pregunta.id == pregunta.id}">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${profesor != null && respuesta.correcta == true}">
                                                                        <div class="col-5 responseTest m-2 rounded-3" style="background-color: #2ec57e">
                            ...
                            <div class="text-center mt-3">
                                <c:choose>
                                    ...
                                    <c:when test="${profesor != null}">
                                        <button class="buttonCustom buttonPink" disabled="disabled" style="opacity: 70%">Enviar</button>
                                    </c:when>
                                    <c:otherwise>
                                        <button class="buttonCustom buttonPink">Enviar</button>
                                    </c:otherwise>
