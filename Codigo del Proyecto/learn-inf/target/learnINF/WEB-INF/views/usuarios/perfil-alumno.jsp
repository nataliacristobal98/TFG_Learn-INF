...
<head>
    ...
    <title>Learn-INF / Perfil de Alumno</title>
    <!--Favicon-->
                    ...
                    <form action="${mvc.basePath}/perfil/editar" method="post" class="px-4 py-2">
                        <div class="form-check text-center" id="icono">
                            <div class="d-inline-block text-center">
                                ...
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon1.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon2.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon2.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon3.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon3.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon4.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon4.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon5.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon5.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon6.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon6.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon7.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon7.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon8.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon8.jpg">
                            </div>

                            <div class="d-inline-block text-center">
                                <img src="${pageContext.request.contextPath}/resources/img/icon9.jpg"
                                     height="100" width="100">
                                <br><input type="radio" name="icono" value="/learnINF/resources/img/icon9.jpg">
                            </div>
                        </div>
