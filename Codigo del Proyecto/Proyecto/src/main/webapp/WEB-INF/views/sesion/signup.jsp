...
<div class="cover-container d-flex p-3 flex-column w-100"
     style="background-image: url('${pageContext.request.contextPath}/resources/img/fondo.jpg');">
        ...
        <div class="text-light">
            ...
            <nav class="nav nav-masthead float-md-end">
                <a href="${mvc.basePath}/mundos/mundo" class="nav-link" aria-current="page" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi bi-globe2 text-light"
                         viewBox="0 0 16 16">
                        <path fill="white"
                ...
                <a href="${mvc.basePath}/perfil" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                         class="bi bi-person-video2 text-light" viewBox="0 0 16 16">
                ...
                <div class="text-end mx-4">
                    <a href="${mvc.basePath}/login" class="btn btn-outline-light me-2 text-white"
                       style="background-color: #fbc46a; border-color: #fab544">Login</a>
                    <a href="${mvc.basePath}/signup" class="btn text-white"
                       style="background-color: #f7a365; border-color: #E38B00FF">Sign-up</a>
                </div>
            </nav>
        </div>
    </header>

    <main class="p-3 mt-5 mb-3 rounded-3 text-center w-50"
          style="background-color: rgba(255,255,255,0.61); margin-inline: auto;">
        <form action="${mvc.basePath}/signup/signup" method="post" class="w-50" style="margin-inline: auto;">
            ...
            <h1 class="h3 mb-3 fw-normal">Resgistrate</h1>

            <div class="text-start">
                <p class="mt-1 mb-0">Nombre y apellidos:</p>
                <input class="form-control" id="nombre" name="nombre" placeholder="Ej: Rosario Martinez Garcia"
                       required>
            </div>
            <div class="text-start">
                ...
                <div class="form-check text-center" id="icono">
                    <div class="d-inline-block text-center">
                        <img src="${pageContext.request.contextPath}/resources/img/icono1.jpg" height="80" width="80" >
                        <br><input type="radio" name="icono" value="icono1">
                    </div>

                    <div class="d-inline-block text-center">
                        <img src="${pageContext.request.contextPath}/resources/img/icono2.jpg" height="80" width="80" >
                        <br><input type="radio" name="icono" value="icono2">
                    </div>

                    <div class="d-inline-block text-center">
                        <img src="${pageContext.request.contextPath}/resources/img/icono3.jpg" height="80" width="80" >
            ...
            <div class="text-start">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button id="show_password" class="btn" style="background-color: #f7a365; color: #ffffff"
                                type="button" onclick="mostrarPassword()"> <span
                                class="bi bi-eye icon"></span> </button>
                </span>
                </div>
            </div>
            ...
            <div class="text-start">
                <p class="mt-3 mb-0">Profesor asignado:</p>
            ...
            <button class="w-75 btn btn-lg mt-3"
                    style="background-color: #f7a365; color: #ffffff;border-color: #E38B00FF" type="submit">Registrarse
            </button>

            <p class="mt-5 mb-3 text-muted">¿Ya tienes cuenta? <a href="${mvc.basePath}/login"
                                                                  style="color: #6d2b7c;">Inicia Sesión</a></p>
        </form>
    </main>
