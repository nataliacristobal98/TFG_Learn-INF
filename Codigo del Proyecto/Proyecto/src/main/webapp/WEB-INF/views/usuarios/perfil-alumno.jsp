...
<div class="cover-container d-flex p-3 flex-column w-100" style="background-image: url('${pageContext.request.contextPath}/resources/img/fondo.jpg');">
    ...
    <main class="p-3 rounded-3 text-center w-50" style="margin-inline: auto;">
            ...
            <div class="card p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-3 w-100">
                        <h4 class="mb-0 mt-0 text-start">${alumno.nombre}</h4>
                        <p class="text-start">Alumno</p>
                        <div class="p-2 mt-2 bg-primary d-flex justify-content-between rounded text-white stats">

                            <div class="d-flex flex-column">
                                <span class="followers">Código</span> <span class="number1">${alumno.codigoAlumno}</span>
                            </div>
                            ...
                            <c:choose>
                                <c:when test="${alumno.puntos >= 10}">
                                    <div class="d-flex flex-column">
                                        <span class="articles">Nivel</span> <span class="number2">Intermedio</span>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="d-flex flex-column">
                                        <span class="articles">Nivel</span> <span class="number2">Básico</span>
                                    </div></c:otherwise>
                            </c:choose>


                            <div class="d-flex flex-column">
                                <span class="articles">Puntos</span> <span class="number3">${alumno.puntos}</span>
                            </div>

                        </div>
                        <div class="button mt-2 d-flex flex-row align-items-center">
                            <a href="${mvc.basePath}/perfil/desconectar" class="btn btn-sm btn-outline-danger w-100">Desconectar sesión</a>
                        </div>
                        <div class="button mt-2 d-flex flex-row align-items-center">
                            <a href="${mvc.basePath}/mundos/mundo" class="btn btn-sm w-100" style="background-color: #f7a365; color: #ffffff;border-color: #E38B00FF">Ir a mundos</a>
                        </div>
                    </div>
                </div>
            </div>
