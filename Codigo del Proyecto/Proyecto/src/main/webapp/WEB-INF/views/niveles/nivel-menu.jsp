...
<div class="cover-container container-fluid d-flex p-3 flex-column w-100" style="background-image: url('${pageContext.request.contextPath}/resources/img/fondo.jpg'); background-repeat: no-repeat">
    ...
    <main class="p-3 m-2 rounded-3 text-center w-100" style="background-color: rgba(255,255,255,0.61); margin-inline: auto;">
            ...
            <h3>Nivel ${nivel.id}</h3>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                                    <a href="#" type="button" class="w-50 btn btn-lg" style="background-color: #6d2b7c; color: #ffffff;border-color: #3b0d49">Estudiar Lección</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="lead text-center">
            <a href="${mvc.basePath}/mundos/mundo/${mundo}" type="button" class="w-25 btn btn-lg" style="background-color: #f7a365; color: #ffffff;border-color: #E38B00FF">Volver a Niveles</a>
        </div>
    </main>
