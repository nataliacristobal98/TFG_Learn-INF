...
<body class="d-flex h-100" style="background-color: #690b95">

<div class="cover-container container-fluid d-flex p-3 flex-column w-100"
    ...
    <main class="p-3 m-2 rounded-3 text-center w-100"
                    ...
                    <form method="post" id="formulario" onsubmit="recogerValores(event)">
                        <c:forEach var="pregunta" items="${preguntas}">
                            ...
                            <div class="card-header rounded-3 py-3">
                               <span style="text-align: right"> <a style="text-decoration: none"
                                                                   href="${mvc.basePath}/api/pregunta/${pregunta.id}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                         class="mb-2 bi bi-question-circle" viewBox="0 0 16 16">
                                      <path fill="#fab544"
                                ...
                                <span style="display: inline-block"><h3
                                        class="my-0 fw-normal text-center">${pregunta.textoPregunta}</h3></span>
